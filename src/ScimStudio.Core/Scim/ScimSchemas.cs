...
/// <summary>The URNs of the schemas and messages RFC 7643 and RFC 7644 define, and the media type they travel in.</summary>
public static class ScimSchemas {
    ...
    public const string MEDIA_TYPE = "application/scim+json";
}
